...
<template>
  <main id="home">
    ...
    category="OUTINGS"
    title="Date at the workplace"
    description="<p class='myWorkHeader'>2 Hours Later He Almost Puked From All You Can Eat Sushi 🍣</p>
    <p>And then, they watched UFC together!!! 😍</p>"
    thumbnail="/images/DateAtTheWorkPlace.png"
    icon="local_bar"
    color="white"
    />    
...
export default {
  ...
  data () {
    return {
      titles: ["Love", "Couple", "Personal Site", "Blog"]
    }
  }
}
</script>
